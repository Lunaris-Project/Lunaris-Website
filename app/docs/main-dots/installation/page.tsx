    ...
    <div className="w-full max-w-full space-y-6">
      <div>
        ...
        <p className="text-lg text-muted-foreground">
          How to install HyprLuna dotfiles on your system.
        </p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <p>
          Before installing HyprLuna, make sure you have the following
          prerequisites:
        </p>
        <ul className="mt-4 space-y-2 list-disc list-inside text-muted-foreground">
          <li>
            A Linux distribution (Arch Linux or Arch-based distributions are
            recommended)
          </li>
        ...
        <div className="rounded-lg border p-4 bg-muted/40 mt-4">
          ...
          <p className="text-sm text-muted-foreground mt-1">
            HyprLuna is primarily designed for Arch Linux and Arch-based
            distributions. While it may work on other distributions, some
        ...
        <div className="space-y-6 mt-6">
          <div>
            ...
            <p className="mt-2 text-muted-foreground">
              We need to install an AUR helper first (better use paru):
            </p>
...
makepkg -si`}
          ...
          <div>
            ...
            <p className="mt-2 text-muted-foreground">
              Then we need to install the needed packages:
            </p>
            <div className="overflow-x-auto">
              <CodeBlock
                code={`paru -S hyprland axel bc cliphist cmake curl rofi-wayland rsync wget ripgrep jq npm meson typescript gjs xdg-user-dirs brightnessctl ddcutil pavucontrol wireplumber libdbusmenu-gtk3 kitty playerctl swww zen-browser git gobject-introspection glib2-devel gvfs glib2 glibc gtk3 gtk-layer-shell libpulse pam gnome-bluetooth-3.0 gammastep libsoup3 libnotify networkmanager power-profiles-daemon rofi-emoji rofi-calc upower adw-gtk-theme-git qt5ct qt5-wayland fontconfig ttf-readex-pro ttf-jetbrains-mono-nerd ttf-material-symbols-variable-git apple-fonts ttf-space-mono-nerd ttf-rubik-vf ttf-gabarito-git fish foot starship polkit-gnome gnome-keyring gnome-control-center blueberry webp-pixbuf-loader gtksourceview3 yad ydotool xdg-user-dirs-gtk tinyxml2 gtkmm3 gtksourceviewmm cairomm xdg-desktop-portal xdg-desktop-portal-gtk xdg-desktop-portal-hyprland gradience python-libsass python-pywalfox matugen-bin python-build python-pillow python-pywal python-setuptools-scm python-wheel swappy wf-recorder grim tesseract tesseract-data-eng slurp dart-sass python-pywayland python-psutil hypridle hyprutils hyprlock wlogout wl-clipboard hyprpicker ghostty ttf-noto-sans-cjk-vf noto-fonts-emoji cava metar gowall go overskride visual-studio-code-bin `}
                filename="Terminal"
                showLineNumbers={true}
              />
            </div>
          ...
          <div>
            ...
            <p className="mt-2 text-muted-foreground">
              We need to install the latest ags v1 repo:
            </p>
            <div className="overflow-x-auto">
              <CodeBlock
                code={`sudo npm i -g typescript
...
makepkg -si`}
          ...
          <div>
            ...
            <p className="mt-2 text-muted-foreground">
              Create a backup of your existing configuration (not needed for
              fresh installations):
            </p>
            <div className="overflow-x-auto">
              <CodeBlock
...
cp -r ~/Pictures ~/HyprLuna-User-Bak/`}
          ...
          <div>
            ...
            <p className="mt-2 text-muted-foreground">
              Clone the HyprLuna repository and set up the configuration:
            </p>
            <div className="overflow-x-auto">
              <CodeBlock
...
sh ~/.config/ags/scripts/color_generation/wallpapers.sh -r`}
      ...
      <div className="space-y-4">
        ...
        <p>
          After installing HyprLuna, you need to log out and log back in to
          apply the changes. You can do this by:
        </p>
        <ol className="mt-4 space-y-2 list-decimal list-inside text-muted-foreground">
          <li>Logging out of your current session</li>
          <li>
            Selecting Hyprland as your desktop environment from the login screen
          </li>
          <li>Logging in with your username and password</li>
        </ol>
        <p className="mt-4">
          Once you're logged in, you should see the HyprLuna desktop
          environment. You can start using it right away!
        </p>
      </div>
        ...
        <div className="rounded-lg border overflow-hidden mt-4">
          ...
          <div className="p-4 space-y-4">
            <div>
              ...
              <p className="text-sm text-muted-foreground mt-1">
                If you get a "permission denied" error when running the
                installation scripts, make sure they are executable:
              </p>
              <div className="overflow-x-auto">
                <CodeBlock
                  code="chmod +x ~/.config/hypr/scripts/*"
                  filename="Terminal"
                />
              </div>
            </div>
            <div>
              ...
              <p className="text-sm text-muted-foreground mt-1">
                If you're missing dependencies, make sure you've installed all
                the required packages listed in Step 2.
              </p>
            </div>
            <div>
              ...
              <div className="overflow-x-auto">
                <CodeBlock
                  code="cat ~/.local/share/hyprland/hyprland.log"
                  filename="Terminal"
                />
              </div>
            </div>
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          >
            ...
            <p className="text-sm text-muted-foreground mt-1">
              Learn the keyboard shortcuts for navigating and controlling
              Hyprland.
            </p>
          </Link>
          <Link
